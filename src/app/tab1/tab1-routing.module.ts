// Importações dos módulos base do Angular para a gestão de navegação
import { NgModule } from '@angular/core';
import { RouterModule, Routes } from '@angular/router';

// Importação do componente visual associado ao primeiro separador (Tab 1)
...
const routes: Routes = [
  {
    ...
    path: '',
    component: Tab1Page, // Associa a rota diretamente ao componente visual correspondente
  }
];

// Decorador que regista as rotas definidas no sistema de navegação como rotas filhas (dependentes)
@NgModule({
